...
//  Data_structure
//
//  Created by Seokhwan Kwon on 2020/09/26.
...
void huffman_tree(int freq[], char ch_list[], int n);   // 허프만코드 생성 함수
